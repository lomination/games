...
//     val board: Board = IndexedSeq.fill(10)(IndexedSeq.fill(10)(Cell.Empty))
// ) extends ZeroSumGame[Checkers, Move],
//       Displayable:
...
//       // if isLegal(m)
//     } yield m
//   def move(move: Move): Option[Checkers] =
...
//   override def eqStates: Seq[Checkers] =
